...
CodeMirror.defineMode("css", function(config, parserConfig) {
  ...
  states.restricted_atBlock = function(type, stream, state) {
    ...
    if (type == "word") {
      if ((state.stateArg == "@font-baidu" && !fontProperties.hasOwnProperty(stream.current().toLowerCase())) ||
  ...
  var nonStandardPropertyKeywords_ = [
    ...
    "scrollbar-baidu-color", "scrollbar-highlight-color", "scrollbar-shadow-color",
