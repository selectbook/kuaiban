    ...
    <div class="web-course-banner">
      <div class="container">
        ...
        <div class="course-list">
          <ul>
            <li class="detail-item">难度：{{ coursedetail.level }}</li>
            <li class="sep"></li>
            <li class="detail-item">时长：{{ coursedetail.hours }}小时</li>
            <li class="sep"></li>
            <li class="detail-item">
              学习人数：{{ coursedetail.learnnumber }}人
            </li>
            <li class="sep"></li>
    ...
    <div class="course-detail">
      <div class="container">
        ...
        <div class="course-img">
          <img
            src="https://www.luffycity.com/static/img/web-introduce.d075499.png"
            alt=""
          />
        </div>
      </div>
    ...
    <div class="course-price">
      <div class="container">
        ...
        <ul class="course-price-item">
          <li
            v-for="(item, index) in coursedetail.prices"
            :key="item.id"
            :class="{ active: index === currentIndex }"
            @click="priceClick(index)"
          >
            <p class="price" :class="{ active: index === currentIndex }">
              ¥{{ item.price }}
            </p>
            <p class="time" :class="{ active: index === currentIndex }">
              有效期{{ item.valid_period_name }}
            </p>
          </li>
        </ul>
